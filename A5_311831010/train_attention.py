...
tdl = DataLoader(tds, batch_size=BATCH_SIZE, shuffle=True)#, num_workers=8)
vdl = DataLoader(ttds, batch_size=BATCH_SIZE, shuffle=True)#, num_workers=8)
...
weights_root = Path("weights_attention")
